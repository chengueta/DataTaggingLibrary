 ...
 */
public class AstMultiNode extends AstNode {
    
    private final AstTextSubNode text;
    private final List<AstTermSubNode> terms;
    private final List<AstAnswerSubNode> answers;

    public AstMultiNode(String id, AstTextSubNode aTextNode, List<AstTermSubNode> someTerms, List<AstAnswerSubNode> someAnswers ) {
        super( id );
        text = aTextNode;
        terms = someTerms;
        answers = someAnswers;
	...
	@Override
	public <T> T accept( AstNode.Visitor<T> v ) {
		return v.visit(this);
	}
    ...
    public boolean equals(Object obj) {
        ...
        if ( !(obj instanceof AstMultiNode) ) {
            return false;
        }
        final AstMultiNode other = (AstMultiNode) obj;
